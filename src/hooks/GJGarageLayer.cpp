...
void CACGarageLayer::startDialogue(){
    ...
    array->addObject(DialogObject::create("Shopkeeper", fmt::format("Hello <cg>{}</c>!", GJAccountManager::get()->m_username), 5, 1, true, {255, 255, 255}));
...
void CACGarageLayer::OnMenuBtnClicked(CCObject*){
    ...
    if (!Save::getDoorOpened()){
        ...
        array->addObject(DialogObject::create("The Cats", "meow meow...", 999, 1, false, ccColor3B{ 255, 255, 255 }));
        array->addObject(DialogObject::create("The Cats", "meow meow meow? (who is it?)", 999, 1, false, ccColor3B{ 255, 255, 255 }));
        array->addObject(DialogObject::create("The Cats", "meow m-meow meow meow.. (want to enter we see..)", 999, 1, false, ccColor3B{ 255, 255, 255 }));
        array->addObject(DialogObject::create("The Cats", "meowmeow meoww meow, <cr>meow</c> m meow meow. (to enter this door, an <cr>Extreme Demon</c> you must beat)", 999, 1, false, ccColor3B{ 255, 255, 255 }));
        ...
        if (!beatenExtremes.size())
            array->addObject(DialogObject::create("The Cats", "meow moewww, meow meow meow.. (it seems that for now, we will wait..)", 999, 1, false, ccColor3B{ 255, 255, 255 }));
        else{
            doSaveDialogue = true;

            array->addObject(DialogObject::create("The Cats", "meow, me meow? (huh, what is it?)", 999, 1, false, ccColor3B{ 255, 255, 255 }));
            array->addObject(DialogObject::create("The Cats", "mmeow meoww-w <cr>meow</c> meow (you've beaten an <cr>Extreme Demon</c> we see)", 999, 1, false, ccColor3B{ 255, 255, 255 }));

            if (beatenExtremes.size() == 1){
                array->addObject(DialogObject::create("The Cats", "<cy>1</c> you have beaten.", 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", fmt::format("<cy>{}</c>", beatenExtremes[0]->m_levelName), 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", "well done! the door may open..", 999, 1, false, ccColor3B{ 255, 255, 255 }));
            }
            else if (beatenExtremes.size() == 2){
                array->addObject(DialogObject::create("The Cats", "<cy>2</c> you have beaten, impressive.", 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", fmt::format("<cy>{}</c> and <cy>{}</c>", beatenExtremes[0]->m_levelName, beatenExtremes[1]->m_levelName), 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", "extraordinary! the door may open..", 999, 1, false, ccColor3B{ 255, 255, 255 }));
            }
                ...
                array->addObject(DialogObject::create("The Cats", "<cy>4</c> you have beaten! what a show of skill!", 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", fmt::format("<cy>{}</c>, <cy>{}</c>, <cy>{}</c> and ALSO <cy>{}</c>!", beatenExtremes[0]->m_levelName, beatenExtremes[1]->m_levelName, beatenExtremes[2]->m_levelName, beatenExtremes[3]->m_levelName), 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", "we are sorry to have underestimated you! the door will be opened immediately!", 999, 1, false, ccColor3B{ 255, 255, 255 }));
            }
            else{
                array->addObject(DialogObject::create("The Cats", fmt::format("you've beaten <cy>{}</c> of them! how incredible!", beatenExtremes.size()), 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", "too many extremes to name!", 999, 1, false, ccColor3B{ 255, 255, 255 }));
                array->addObject(DialogObject::create("The Cats", "you are welcome within our hideout! the door will be opened immediately!", 999, 1, false, ccColor3B{ 255, 255, 255 }));
            }
        }
...
void CACGarageLayer::postDoorOpenDialogue(){
    ...
    array->addObject(DialogObject::create("Shopkeeper", "Woah! What was that loud <cr>BOOM</c> sound!", 5, 1, true, {255, 255, 255}));
    ...
    array->addObject(DialogObject::create("The Cats", "meow.. (hello..)", 999, 1, false, ccColor3B{ 255, 255, 255 }));
    ...
    array->addObject(DialogObject::create("The Cats", "meow.. mmeow meoww moewwwwww (we are cats.. not from these lands >:()", 999, 1, false, ccColor3B{ 255, 255, 255 }));
    ...
    array->addObject(DialogObject::create("The Cats", "We are the cats! we come in peace!", 999, 1, false, ccColor3B{ 255, 255, 255 }));
    ...
    array->addObject(DialogObject::create("The Cats", "We are sorry if we disturbed you, we do not wish any harm!", 999, 1, false, ccColor3B{ 255, 255, 255 }));
    ...
    array->addObject(DialogObject::create("The Cats", "Thanks for helping us introduce ourselves to this local, we were having trouble doing that ourselves", 999, 1, false, ccColor3B{ 255, 255, 255 }));
    array->addObject(DialogObject::create("The Cats", "Feel free to come visit our hideout anytime! See you later :)", 999, 1, false, ccColor3B{ 255, 255, 255 }));
